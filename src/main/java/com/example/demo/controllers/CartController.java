...
public class CartController {
    ...
    @Autowired
    public CartController(CartItemServices cartItemServices, ProductServices productServices, UserService userService) {
    ...
    public String addToCart(@RequestParam Long productId, 
        ...
        try {
            ...
            Product product = productServices.findById(productId).orElseThrow(() -> new IllegalArgumentException("Product not found"));
